...
import (
	...
	_ "github.com/go-sql-driver/mysql" // We are not going to call any function from this Github library/package, it is just for the sake of basically doing required setup for MySQL
)
...
func main() {
	fmt.Printf("Opening the %s ... ", dbu.DbName) // dbu here is the short form for dbutil opackage that we have imported
